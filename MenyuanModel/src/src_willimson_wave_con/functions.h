...
#ifdef FREE_SURFACE
void solveContravariantJac( MPI_Comm comm_cart, GRID grid, CONTRAVARIANT con, COORD coord, float * Jac, 
...
void MPI_SendRecv_con_jac(MPI_Comm comm_cart, GRID grid, MPI_NEIGHBOR mpiNeighbor, CONTRAVARIANT con, float * Jac);
...
void pmlDeriv( 
	...
	MPI_BORDER border, 
	int FB1, int FB2, int FB3, float A, float B, float DT );
