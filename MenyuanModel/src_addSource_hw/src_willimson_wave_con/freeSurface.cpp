...
//=======================================================
		...
		h_W.Vx [index] 	= A * (float)h_W.Vx [index] + h_WVx  * DT;							
		h_W.Vy [index] 	= A * (float)h_W.Vy [index] + h_WVy  * DT;							
		h_W.Vz [index] 	= A * (float)h_W.Vz [index] + h_WVz  * DT;							
		h_W.Txx[index] 	= A * (float)h_W.Txx[index] + h_WTxx * DT;						
		h_W.Tyy[index] 	= A * (float)h_W.Tyy[index] + h_WTyy * DT;						
		h_W.Tzz[index] 	= A * (float)h_W.Tzz[index] + h_WTzz * DT;						
		h_W.Txy[index] 	= A * (float)h_W.Txy[index] + h_WTxy * DT;						
		h_W.Txz[index] 	= A * (float)h_W.Txz[index] + h_WTxz * DT;						
		h_W.Tyz[index] 	= A * (float)h_W.Tyz[index] + h_WTyz * DT;						
	END_CALCULATE3D( )																													
}			
