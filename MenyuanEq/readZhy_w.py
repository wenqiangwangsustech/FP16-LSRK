...
zy_data = np.loadtxt("zhangyong.txt")
NT = len( zy_data[0,10:] )
...
for it in range( 0, NT ):
	interp = CloughTocher2DInterpolator(list(zip(X, Y)), slipRate[:,it])
...
sourceFileName = params["sourceDir"] + "/ZhangyongSource.bin"
