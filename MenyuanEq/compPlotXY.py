...
if DrawDiff:
	...
	plt.savefig("PDF/Menyuan_%d_" % it +  fileName + var + "Diff" + ".pdf", dpi = dpi, bbox_inches = "tight" )
else:
	...
	plt.savefig( "PDF/Menyuan_%d_" % it +  fileName + var +  ".pdf", dpi = dpi, bbox_inches = "tight" )
