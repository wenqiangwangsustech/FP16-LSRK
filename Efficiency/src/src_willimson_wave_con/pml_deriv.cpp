...
{																
	...
	CALCULATE3D( i0, j0, k0, 0, nPML, 0, ny, 0, nz )
		...
		h_Aux_x.Vx [pos] = A * h_Aux_x.Vx [pos] + ( Vx1  - alpha_d_x * Aux_x.Vx [pos] ) * DT;
		h_Aux_x.Vy [pos] = A * h_Aux_x.Vy [pos] + ( Vy1  - alpha_d_x * Aux_x.Vy [pos] ) * DT;
		h_Aux_x.Vz [pos] = A * h_Aux_x.Vz [pos] + ( Vz1  - alpha_d_x * Aux_x.Vz [pos] ) * DT;
		h_Aux_x.Txx[pos] = A * h_Aux_x.Txx[pos] + ( Txx1 - alpha_d_x * Aux_x.Txx[pos] ) * DT;
		h_Aux_x.Tyy[pos] = A * h_Aux_x.Tyy[pos] + ( Tyy1 - alpha_d_x * Aux_x.Tyy[pos] ) * DT;
		h_Aux_x.Tzz[pos] = A * h_Aux_x.Tzz[pos] + ( Tzz1 - alpha_d_x * Aux_x.Tzz[pos] ) * DT;
		h_Aux_x.Txy[pos] = A * h_Aux_x.Txy[pos] + ( Txy1 - alpha_d_x * Aux_x.Txy[pos] ) * DT;
		h_Aux_x.Txz[pos] = A * h_Aux_x.Txz[pos] + ( Txz1 - alpha_d_x * Aux_x.Txz[pos] ) * DT;
		h_Aux_x.Tyz[pos] = A * h_Aux_x.Tyz[pos] + ( Tyz1 - alpha_d_x * Aux_x.Tyz[pos] ) * DT;
...
{																	
	...
	CALCULATE3D( i0, j0, k0, 0, nx, 0, nPML, 0, nz )
		...
		h_Aux_y.Vx [pos] = A * h_Aux_y.Vx [pos] + ( Vx2  - alpha_d_y * Aux_y.Vx [pos] ) * DT;		
		h_Aux_y.Vy [pos] = A * h_Aux_y.Vy [pos] + ( Vy2  - alpha_d_y * Aux_y.Vy [pos] ) * DT;		
		h_Aux_y.Vz [pos] = A * h_Aux_y.Vz [pos] + ( Vz2  - alpha_d_y * Aux_y.Vz [pos] ) * DT;		
		h_Aux_y.Txx[pos] = A * h_Aux_y.Txx[pos] + ( Txx2 - alpha_d_y * Aux_y.Txx[pos] ) * DT;		
		h_Aux_y.Tyy[pos] = A * h_Aux_y.Tyy[pos] + ( Tyy2 - alpha_d_y * Aux_y.Tyy[pos] ) * DT;		
		h_Aux_y.Tzz[pos] = A * h_Aux_y.Tzz[pos] + ( Tzz2 - alpha_d_y * Aux_y.Tzz[pos] ) * DT;		
		h_Aux_y.Txy[pos] = A * h_Aux_y.Txy[pos] + ( Txy2 - alpha_d_y * Aux_y.Txy[pos] ) * DT;		
		h_Aux_y.Txz[pos] = A * h_Aux_y.Txz[pos] + ( Txz2 - alpha_d_y * Aux_y.Txz[pos] ) * DT;		
		h_Aux_y.Tyz[pos] = A * h_Aux_y.Tyz[pos] + ( Tyz2 - alpha_d_y * Aux_y.Tyz[pos] ) * DT;		
...
{																
	...
	CALCULATE3D( i0, j0, k0, 0, nx, 0, ny, 0, nPML )
		...
		h_Aux_z.Vx [pos] = A * h_Aux_z.Vx [pos] +  ( Vx3  - alpha_d_z * Aux_z.Vx [pos] ) * DT;	
		h_Aux_z.Vy [pos] = A * h_Aux_z.Vy [pos] +  ( Vy3  - alpha_d_z * Aux_z.Vy [pos] ) * DT;	
		h_Aux_z.Vz [pos] = A * h_Aux_z.Vz [pos] +  ( Vz3  - alpha_d_z * Aux_z.Vz [pos] ) * DT;	
		h_Aux_z.Txx[pos] = A * h_Aux_z.Txx[pos] +  ( Txx3 - alpha_d_z * Aux_z.Txx[pos] ) * DT;	
		h_Aux_z.Tyy[pos] = A * h_Aux_z.Tyy[pos] +  ( Tyy3 - alpha_d_z * Aux_z.Tyy[pos] ) * DT;	
		h_Aux_z.Tzz[pos] = A * h_Aux_z.Tzz[pos] +  ( Tzz3 - alpha_d_z * Aux_z.Tzz[pos] ) * DT;	
		h_Aux_z.Txy[pos] = A * h_Aux_z.Txy[pos] +  ( Txy3 - alpha_d_z * Aux_z.Txy[pos] ) * DT;	
		h_Aux_z.Txz[pos] = A * h_Aux_z.Txz[pos] +  ( Txz3 - alpha_d_z * Aux_z.Txz[pos] ) * DT;	
		h_Aux_z.Tyz[pos] = A * h_Aux_z.Tyz[pos] +  ( Tyz3 - alpha_d_z * Aux_z.Tyz[pos] ) * DT;	
...
void pmlDeriv( GRID grid, WAVE h_W, WAVE W, CONTRAVARIANT_FLOAT con, MEDIUM_FLOAT medium, AUX4 Aux4_1, AUX4 Aux4_2, PML_ALPHA pml_alpha, PML_BETA pml_beta, PML_D pml_d, MPI_BORDER border, int FB1, int FB2, int FB3, float A, float B, float DT )
