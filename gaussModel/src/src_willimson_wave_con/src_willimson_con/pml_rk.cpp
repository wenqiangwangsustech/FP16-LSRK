...
void newPmlRk( GRID grid, MPI_BORDER border, int irk, AUX4 Aux4_1, AUX4 Aux4_2, float B, float DT )
{
	...
	if ( border.isx1 )	new_wave_rk<<< blockX, thread >>>( Aux4_1.h_Aux_x.Vx, Aux4_1.Aux_x.Vx, numx, B, DT );
	if ( border.isy1 )  new_wave_rk<<< blockY, thread >>>( Aux4_1.h_Aux_y.Vx, Aux4_1.Aux_y.Vx, numy, B, DT );
	if ( border.isz1 )  new_wave_rk<<< blockZ, thread >>>( Aux4_1.h_Aux_z.Vx, Aux4_1.Aux_z.Vx, numz, B, DT );
	if ( border.isx2 )	new_wave_rk<<< blockX, thread >>>( Aux4_2.h_Aux_x.Vx, Aux4_2.Aux_x.Vx, numx, B, DT );
	if ( border.isy2 )  new_wave_rk<<< blockY, thread >>>( Aux4_2.h_Aux_y.Vx, Aux4_2.Aux_y.Vx, numy, B, DT );
                                                                                                  
#ifndef FREE_SURFACE
	if ( border.isz2 )  new_wave_rk<<< blockZ, thread >>>( Aux4_2.h_Aux_z.Vx, Aux4_2.Aux_z.Vx, numz, B, DT );
#endif                                                                                                               

#else                                                                                                                              
                                                                                                                                   
	if ( border.isx1 )	new_wave_rk( Aux4_1.h_Aux_x.Vx, Aux4_1.Aux_x.Vx, numx, B, DT );
	if ( border.isy1 )  new_wave_rk( Aux4_1.h_Aux_y.Vx, Aux4_1.Aux_y.Vx, numy, B, DT );
	if ( border.isz1 )  new_wave_rk( Aux4_1.h_Aux_z.Vx, Aux4_1.Aux_z.Vx, numz, B, DT );
    //                                                              
	if ( border.isx2 )	new_wave_rk( Aux4_2.h_Aux_x.Vx, Aux4_2.Aux_x.Vx, numx, B, DT );
	if ( border.isy2 )  new_wave_rk( Aux4_2.h_Aux_y.Vx, Aux4_2.Aux_y.Vx, numy, B, DT );
#ifndef FREE_SURFACE
	if ( border.isz2 )  new_wave_rk( Aux4_2.h_Aux_z.Vx, Aux4_2.Aux_z.Vx, numz, B, DT );
#endif                                                                                                               
